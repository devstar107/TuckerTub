...
export const TermsAndConditionsContent = () => {
  return (
    <div className="preflight-escape h-full bg-colorFifteen py-12">
      <Wrapper>
        <Title className="text-colorFourteen">Terms of Service</Title>
        <div className="md:[80%] text-colorFourteen sm:w-full lg:w-[80%]">
          <h2>Terms of Service</h2>
          <p>
            These Terms of Service govern your use of the website located at{' '}
            <NextLink href={frontendUrl}>{frontendUrl}</NextLink> and any related services provided
            by Tucker Tub Pet Food.
          </p>
          <p>
            By accessing <NextLink href={frontendUrl}>{frontendUrl}</NextLink>, you agree to abide
            ...
            this website or using any other services provided by Tucker Tub Pet Food.
          </p>
          <p>
            We, Tucker Tub Pet Food, reserve the right to review and amend any of these Terms of
          ...
          <p>These Terms of Service were last updated on 10 August 2022. </p>
          ...
          <ol>
            ...
            <li>
              ...
              that abuses or disrupts our networks or any other service Tucker Tub Pet Food
              provides;
            </li>
            <li>
          ...
          <p>
            ...
            licensed to Tucker Tub Pet Food and are protected by applicable copyright and trademark
          ...
          <p>
            ...
            Service, and may be terminated by Tucker Tub Pet Food at any time.
          </p>
          <h3>Liability</h3>
          <p>
            Our website and the materials on our website are provided on an 'as is' basis. To the
            extent permitted by law, Tucker Tub Pet Food makes no warranties, expressed or implied,
          ...
          <p>
            In no event shall Tucker Tub Pet Food or its suppliers be liable for any consequential
            loss suffered or incurred by you or any third party arising from the use or inability to
            use this website or the materials on this website, even if Tucker Tub Pet Food or an
            authorised representative has been notified, orally or in writing, of the possibility of
            such damage.
          </p>
          <p>
          ...
          <p>
            ...
            information purposes only. Tucker Tub Pet Food does not warrant or make any
          ...
          <h3>Links</h3>
          <p>
            Tucker Tub Pet Food has not reviewed all of the sites linked to its website and is not
            responsible for the contents of any such linked site. The inclusion of any link does not
            imply endorsement, approval or control by Tucker Tub Pet Food of the site. Use of any
          ...
          <p>
            ...
            Australia. You irrevocably submit to the exclusive jurisdiction of the courts in that
            State or location.
          </p>
        </div>
      </Wrapper>
