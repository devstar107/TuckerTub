...
export const CookiePolicyContent = () => {
  return (
    <div className="preflight-escape h-full bg-colorFifteen py-12">
      <Wrapper>
        <Title className="text-colorFourteen">Cookie Policy</Title>
        <div className="md:[80%] text-colorFourteen sm:w-full lg:w-[80%]">
          <h2>Cookie Policy</h2>
          <p>
            We use cookies to help improve your experience of our website at
            <NextLink href={frontendUrl}>{frontendUrl}</NextLink>. This cookie policy is part of
            Tucker Tub Pet Food&#39;s privacy policy. It covers the use of cookies between your
            device and our site.
          </p>
          <p>
          ...
          <p>
            ...
            cookies from <NextLink href={frontendUrl}>{frontendUrl}</NextLink>. In such a case, we
          ...
          <p>
            ...
            allows the site to recognise your web browser when you return, additional data that
            serves the cookie's purpose, and the lifespan of the cookie itself.
          </p>
          <p>
            Cookies are used to enable certain features (eg logging in), track site usage (eg
            analytics), store your user settings (eg time zone, notification preferences), and to
          ...
          <p>
            ...
            With this information, websites can provide you with customised, enhanced, or optimised
          ...
          <p>
            ...
            improve the effectiveness of their campaigns and the quality of content presented to
            you. These cookies may be set by the website you're visiting (first-party) or by
