...
export const PrivacyPolicyContent = () => {
  return (
    <div className="preflight-escape h-full bg-colorFifteen py-12">
      <Wrapper>
        <Title className="text-colorFourteen">Privacy Policy</Title>
        <div className="md:[80%] text-colorFourteen sm:w-full lg:w-[80%]">
          <h2>Privacy Policy</h2>
          <p>
            Your privacy is important to us. It is Tucker Tub Pet Food's policy to respect your
            ...
            <NextLink href={frontendUrl}>{frontendUrl}</NextLink>, and other sites we own and
            operate.
          </p>
          <p>
          ...
          <p>This policy is effective as of 10 August 2022. </p>
          <p>Last updated: 10 August 2022 </p>
          ...
          <p>
            ...
            and warrant that you have such person's consent to provide the personal information to
            us.
          </p>
          <p>
          ...
          <p>
            Privacy Manager
            <br />
            <NextLink className="underline" href="/contact">
              Contact Us
            </NextLink>
          </p>
        </div>
