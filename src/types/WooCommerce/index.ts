...
// Types grabbed from https://github.com/rrrhys/wootoapp-rewrite/blob/master/app/types/woocommerce.d.ts
...
export interface Order {
  ...
  billing?: Billing
  shipping?: Shipping
  payment_method: 'bacs' | 'cheque' | 'cod' | 'credit-card' | 'custom' | 'paypal' | 'stripe'
